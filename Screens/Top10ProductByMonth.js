...
import back from '../Images/back.png'  
 export default function Top10ProductByMonth({ route, navigation})  {
    ...
    return (
        <View>
            ...
            <Text style={styles.text_header1}>Top 10 sản phẩm bán chạy nhất trong tháng {month} năm {year}</Text>
