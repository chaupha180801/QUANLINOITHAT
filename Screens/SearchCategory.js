...
export default function SearchCategory({ route,navigation }) {
  ...
  const search_category = () => {
    ...
    db.transaction((tx) => {
      tx.executeSql(
        'SELECT * FROM DANHMUC WHERE lower(TENDANHMUC) LIKE ?',
        [`%${searchText}%`],
        (tx, results) => {
  ...
  return (
    ...
    <SafeAreaView style={{marginHorizontal: 10, top: 20, height: 550}}>
