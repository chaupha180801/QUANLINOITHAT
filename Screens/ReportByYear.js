...
export default function ReportByYear({route, navigation}) {
    ...
    <View>
       <Image source={login} style={styles.image}/>
          <View styles={styles.header}>
              ...
              <Text style={styles.text_header}>Báo cáo theo năm</Text>
              <TextInput
          ...
          <View style={styles.body}>
            <TouchableOpacity style={styles.button_top1} onPress={()=>{navigation.navigate('Top10ProductByYear', {id:id, username: username, year: year})}}>
             <Image source={top1} style={styles.image_top1}/>
             <Text style={styles.text1}>Top 10 sản phẩm bán chạy</Text>
             <Text style={styles.text2}>Tên sản phẩm, số lượng bán theo năm</Text>
            </TouchableOpacity>
            <TouchableOpacity style={styles.button_top2} onPress={()=>{navigation.navigate('ReportTurnover', {id:id, username: username, year: year})}}>
            ...
            <TouchableOpacity style={styles.button_top4} onPress={()=>{navigation.navigate('Top10CustomerByYear', {id:id, username: username, year: year})}}>
